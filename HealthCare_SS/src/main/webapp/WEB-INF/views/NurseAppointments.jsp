  ...
  <div style="float:left; margin-left:200px; ">
   ...
   <%--  <form:form>	 --%>
	...
	<c:forEach var="appt" items="${apptList}">
		...
		<%-- 	<td><a href="<c:out value='AddVitalSigns?apptId=${appt.appointmentId}'/>" >AddVitalSigns</a></td> --%>
			<td>
			<form:form action="nurseAddVitals" method="post">
              <input type="Submit" value="AddVitalSigns" class="btn btn-warning" />
